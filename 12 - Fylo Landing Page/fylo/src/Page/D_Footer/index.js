  ...
  return (
    <FooterContainer>
      <Container footerDesktop>
        <Img src={fyloLogoImg} alt="Logo" fyloLogoImgFooter />
        <Container footerInsideInfoContainer>
          <Img src={iconPhone} alt="iconPhone" iconPhone />
          <Subtitle content="Phone: +1-543-123-4567" subtitleFooter />
        </Container>
        <Container footerInsideInfoContainer>
          <Img src={iconEmail} alt="iconEmail" iconEmail />
          <Subtitle content="example@fylo.com" subtitleFooter />
        </Container>
      </Container>

      <Container footerInsideLinksContainer>
      ...
      <Container footerSocialMediaContainer>
        <FacebookIcon />
        <InstagramIcon />
        <TwitterIcon />
      </Container>
